...
const Hero = () => {
  return (
    <section className="relative bg-hero-mobile xs:bg-hero bg-no-repeat overflow-hidden bg-right-top py-24 lg:py-28 xl:pt-40 xl:pb-48">
      <div className="max-w-base mx-auto flex px-9">
        ...
        <div>
          <Image
            className="absolute w-64 h-[13.5625rem] sm:h-1/2 sm:w-1/2 lg:h-2/3 xl:h-2/3 xl:w-auto -right-1/4 xs:right-0 bottom-[40%] sm:bottom-[30%] lg:bottom-[15%]"
            width={654}
            height={654}
